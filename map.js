...
for (var i = 0; i < locationsData.length; i++) {
  ...
  google.maps.event.addListener(marker, 'click', function() {
    infoBubble.close();
    infoBubble.setContent('<img src="' + this.image + '" style="max-width: 286px;" /><div class="info" style="display: inline; position: absolute; top: 0; width: 286px; padding: 15px;box-sizing: border-box;"><h4 class="amber">' + this.name + '</h4>' + '<p class="category">' + this.category + '</p>' + '<p><span class="amber">#</span>' + this.hashtag + '</p><p><span class="amber"> Posts: </span>  ' + this.posts + '</p><p class="copy">' + this.copy + '</p></div>');
    ...
    if(screen.width > 800) {
      ...
      $('.info-content').parent().css('overflow', 'auto');
    }
