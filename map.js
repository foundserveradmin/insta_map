...
var entertainmentData = [
  {
   ...
   },
   {
     ...
     "copy": "London Stadium was built to host 2012 Summer Olympic Games, and to this day, is used to host sports events such as the Rugby World Cup, or The Race of Champions. Through the summer, the stadium stages global talents such as Jay-Z and Beyoncé.",
     "hotness": 1.6513
   },
   {
   ...
   },
   {
     ...
     "copy": "Gory and macabre come back to life at this must-see landmark. London Dungeons is the unique thrilling attraction located underneath London Bridge. Explore its gripping sets to get the boost of adrenaline, and make some spine-chilling memories.",
     "hotness": 1.3011
   },
   {
...
var foodData = [
  ...
  },
  {
    ...
    "copy": "Rock's Roll is not dead at Ace’s Café. Established as long ago as in 1938, this first London’s roadhouse diner is the capital of the \"cafe racing\" phenomenon.  Visit it for a hearty full English Breakfast and a cup of black coffee to keep the levels of adrenaline and energy up.  ",
    "hotness": 4.9613
  },
  {
    "name": "Berners Tavern",
  ...
  },
  {
    ...
    "copy": "It’s hard to pass by The Wolseley without wanting to step in, even for a quick tipple. This all-day, ritzy  - style café sits right in the middle of the iconic Piccadilly Street, waiting for you to come in and enjoy the delights of European Grand Café Traditional cuisine. ",
    "hotness": 3.4445
  },
  {
    "name": "Tom's Kitchen",
  ...
  },
  {
    ...
    "copy": "Described as “stodgetastic” by TimeOut, you should have a good indication of what to expect at this art deco themed café. Regency Café is frequently ranked as one of the best restaurants in London, take a trip and see for yourself. ",
    "hotness": 1.3762
  },
  {
    ...
    "copy": "No two days are ever the same at Union Street Café, due to the daily changing menu. This converted warehouse, located in Southwark, serves Mediterranean dishes. The best part about? Gordan Ramsey is the owner.",
    "hotness": 1.3503
  },
  {
    "name": "Madison London",
  ...
  },
  {
    ...
    "copy": "Not only a 5-star hotel located in exclusive Knightsbridge, the Mandarin Oriental has not one but two outstanding restaurants, a bar, a lounge and impeccable service and décor that will make friends and family jealous of your Instagram feed. ",
    "hotness": 1.053
  },
  {
